...
public class DistrictParkPatch {
    private static bool[] Initialized { get; set; } = [false, false, false, false, false, false];

    public static void Patch(HarmonyPatcher harmonyPatcher) {
        harmonyPatcher.ApplyPrefix(AccessTools.Method(typeof(DistrictPark), "IndustrySimulationStep"), AccessTools.Method(typeof(DistrictParkPatch), nameof(IndustrySimulationStepPrefix)));
    }
